      ...
      <Container>
        ...
        <Row className={Styles.terms}>
          <h4>
            ...
            <br />
            <br />
            Securing your data GunHunterNFT. will take reasonable technical and
            organisational precautions to prevent the loss, misuse or alteration
            of your personal information.
            <br />
            GunHunterNFT. will store some of the personal information you
            provide on its secure servers.
            <br />
            <br />
            Cross-border data transfers Information that GunHunterNFT. collects
            may be stored and processed in and transferred between any of the
            countries in which GunHunterNFT. operates to enable the use of the
            information in accordance with this privacy policy.
            <br />
            In addition, personal information that you submit for publication on
            the Platforms may be published on the internet and may be available
            around the world.
            <br />
            You agree to such cross-border transfers of personal information.
            <br />
            <br />
            Updating this statement GunHunterNFT. may update this privacy policy
            by posting a new version on this website. You should check this page
            occasionally to ensure you are familiar with any changes.
            <br />
            <br />
            Other websites The Platforms could contain links to other websites,
            applications and services.
            <br />
            GunHunterNFT. is not responsible for the privacy policies or
            ...
            guidance. Everything that we provide on the Platforms is purely for
            informational and educational purposes only and should not be relied
            upon as investment advice or the most up-to-date information. All
            information contained herein should be independently verified and
            confirmed. GunHunterNFT. is not liable for any loss or damage
            ...
            <br />
            <br />
            Disclaimer Trading and investing in cryptocurrencies (also called
            digital or virtual currencies, crypto assets, altcoins, etc)
            involves substantial risk of loss and is not suitable for every
            investor. The valuation of cryptocurrencies and futures may
            fluctuate, and, as a result, clients may lose more than their
            original investment. The highly leveraged nature of futures trading
            means that small market movements will have a great impact on your
            trading account and this can work against you, leading to large
            losses or can work for you, leading to large gains.
            <br />
            If the market moves against you, you may sustain a total loss
            greater than the amount you deposited into your account. You are
            responsible for all the risks and financial resources you use and
            for the chosen trading system. You should not engage in trading
            unless you fully understand the nature of the transactions you are
            entering into and the extent of your exposure to loss. If you do not
            ...
            cryptocurrencies, transaction or investment strategy is suitable for
            any specific person. None of the information providers or their
            affiliates will advise you personally concerning the nature,
            ...
            relying on your own judgment. Any opinions, news, research,
            analyses, prices, or other information contained on the Platforms
            are provided as general market commentary, and do not constitute
            investment advice.
            <br />
            <br />
